...
if __name__ == '__main__':
    ...
    name = "PTTE3"
    subname = f"PTTE3_bs-{batch_size}_lr-{lr}_lamda{lamda}_sd-{seed}"  #
    ...
    dataset_train = TrajDataset3("./data16_train_cc.csv")  #
    dataset_val = TrajDataset3("./data16_val_cc.csv")
    ...
    for epoch in tqdm(range(0, n_epochs)):
        ...
        for inputs, link_len, labels in traj_dataloader(dataset_train, batch_size, True):
            ...
            labels2 = labels[1].to(device)  # 放到gpu里
